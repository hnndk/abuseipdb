...
class IrisAbuseIPDBInterface(IrisModuleInterface):
    ...
    def _handle_ioc(self, data) -> InterfaceStatus.IIStatus:
        ...
        abuse_handler =AbuseIPDBHandler(mod_config=self.module_dict_conf,
        ...
        for element in data:
            ...
            if 'ip-' in element.ioc_type.type_name:
                ...
                self.log.error(f'IOC type {element.ioc_type.type_name} not handled by AbuseDB module. Skipping')
